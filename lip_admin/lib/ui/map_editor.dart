...
class _MapEditorState extends State<MapEditor> {
  ...
  _addPointToPolygon() async {
    ...
    try {
      if (land.polygon == null) {
        land.polygon = List();
      }
      land.polygon.add(CoordinatesDTO(latLng.latitude, latLng.longitude));
      _key.currentState.removeCurrentSnackBar();
      print("Point added to polygon, points: ${land.polygon.length}");
    } catch (e) {
  ...
  void _placeNewMarker() {
    var marker = Marker(
        ...
        infoWindow: InfoWindow(
            ...
            snippet: 'Point in LandDTO Polygon',
            onTap: () {
