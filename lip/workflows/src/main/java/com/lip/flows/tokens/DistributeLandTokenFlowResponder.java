...
@InitiatedBy(DistributeLandTokenFlow.class)
public class DistributeLandTokenFlowResponder extends FlowLogic<SignedTransaction> {
    private final static Logger logger = LoggerFactory.getLogger(DistributeLandTokenFlowResponder.class);
    private final FlowSession counterPartySession;

    public DistributeLandTokenFlowResponder(FlowSession counterPartySession) {
    ...
    public SignedTransaction call() throws FlowException {
        logger.info("\uD83C\uDF77 \uD83C\uDF77 \uD83C\uDF77  DistributeLandTokenFlowResponder call method at " + new Date().toString());
        ...
        logger.info("🤟 🤟 🤟 DistributeLandTokenFlowResponder returning signedTransaction \uD83C\uDF77 \uD83E\uDD1F \uD83C\uDF4F \uD83C\uDF4E ".concat(signedTransaction.toString()));
